package com.example.hms.ui.auth.password
...
@Composable
fun TPasswordScreen(navController: NavHostController, rootInterface: RootInterface){
    BaseScreen {
        Row(
            modifier = Modifier
            ...
            Column(
                ...
                MSpacerH20()
                MText16(textRes = R.string.set_password)
                MSpacerH40()
                MPasswordTextField(
                ...
                MSpacerH20()
                MFilledButton(labelRes = R.string.set_password) {
